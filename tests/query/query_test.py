...
def test_format_odata_date() -> None:
    ...
    # string datetimes with Z (preserved as-is)
    assert _format_odata_date("2020-01-01T12:00:00Z") == "2020-01-01T12:00:00Z"
    # string datetimes without Z (gets .000Z appended)
